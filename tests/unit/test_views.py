...
class InitialTests(TestCase):
    ...
    def test_update_message(self):
        ...
        new_message_message_1 = 'Updated message'
        data = {'printed_times': new_printed_times, 'printed_once': new_printed_once, 'message': new_message_message_1, 'duration': 60 }
        patch_response = self.test_client.patch(
            new_message_url, 
            headers=self.get_authentication_headers(self.test_user_name, self.test_user_password),
            data=json.dumps(data))
        ...
        self.assertEqual(get_response_data['message'], new_message_message_1)
        self.assertEqual(get_response_data['duration'], 60)
